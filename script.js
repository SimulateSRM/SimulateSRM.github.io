...
async function updateImages() {
    ...
    if (imageType === "charts") {
        ...
        img1a.src = `Images/allsky_rgb_${imageType}_${aerosol1}_rf${rf1}_tr${tropo1.toString().replace(".", "")}_sz${sza}.png`;
        img2a.src = `Images/allsky_rgb_${imageType}_${aerosol2}_rf${rf2}_tr${tropo2.toString().replace(".", "")}_sz${sza}.png`;
        colImg1a.classList.remove("d-none");
        ...
        img1a.src = `Images/allsky_rgb_${imageType}_${aerosol1}_rf${rf1}_tr${tropo1.toString().replace(".", "")}_sz${sza}.png`;
        img1b.src = `Images/allsky_rgb_${imageType}_${aerosol2}_rf${rf2}_tr${tropo2.toString().replace(".", "")}_sz${sza}.png`;
        colImg1a.classList.remove("d-none");
